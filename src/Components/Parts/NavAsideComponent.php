<?php
/* src/Components/Parts/NavAsideComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'parts:nav-aside', template: '@SurvosTabler/components/parts/nav-aside.html.twig')]
final class NavAsideComponent
{
    use DataAwareTrait;
