<?php
/* src/Components/Cards/IconsComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:icons', template: '@SurvosTabler/components/cards/icons.html.twig')]
final class IconsComponent
{
    use DataAwareTrait;
