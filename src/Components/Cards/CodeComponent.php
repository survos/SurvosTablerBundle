<?php
/* src/Components/Cards/CodeComponent.php v3.9 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:code', template: '@SurvosTabler/components/cards/code.html.twig')]
final class CodeComponent
{
    use DataAwareTrait;
