<?php
/* src/Components/Cards/SignUpComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:sign-up', template: '@SurvosTabler/components/cards/sign-up.html.twig')]
