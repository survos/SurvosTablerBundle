<?php
/* src/Components/Cards/Card2Component.php v3.9 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:card-2', template: '@SurvosTabler/components/cards/card-2.html.twig')]
final class Card2Component
{
    use DataAwareTrait;
