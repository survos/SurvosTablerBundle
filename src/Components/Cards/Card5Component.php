<?php
/* src/Components/Cards/Card5Component.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:card-5', template: '@SurvosTabler/components/cards/card-5.html.twig')]
final class Card5Component
{
    use DataAwareTrait;
