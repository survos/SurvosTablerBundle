<?php
/* src/Components/Cards/ConfigurationComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:configuration', template: '@SurvosTabler/components/cards/configuration.html.twig')]
