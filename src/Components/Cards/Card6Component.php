<?php
/* src/Components/Cards/Card6Component.php v3.9 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:card-6', template: '@SurvosTabler/components/cards/card-6.html.twig')]
final class Card6Component
{
    use DataAwareTrait;
