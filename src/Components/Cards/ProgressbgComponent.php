<?php
/* src/Components/Cards/ProgressbgComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:progressbg', template: '@SurvosTabler/components/cards/progressbg.html.twig')]
