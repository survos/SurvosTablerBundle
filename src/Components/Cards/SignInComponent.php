<?php
/* src/Components/Cards/SignInComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:sign-in', template: '@SurvosTabler/components/cards/sign-in.html.twig')]
