<?php
/* src/Components/Cards/OrderStatisticsComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:order-statistics', template: '@SurvosTabler/components/cards/order-statistics.html.twig')]
final class OrderStatisticsComponent
{
    use DataAwareTrait;

    public ?iterable $orders = null;
