<?php
/* src/Components/Cards/Card1Component.php v3.9 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:card-1', template: '@SurvosTabler/components/cards/card-1.html.twig')]
final class Card1Component
{
    use DataAwareTrait;
