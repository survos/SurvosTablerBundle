<?php
/* src/Components/Cards/Card3Component.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:card-3', template: '@SurvosTabler/components/cards/card-3.html.twig')]
final class Card3Component
{
    use DataAwareTrait;
