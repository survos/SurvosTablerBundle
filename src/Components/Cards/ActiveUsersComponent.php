<?php
/* src/Components/Cards/ActiveUsersComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:active-users', template: '@SurvosTabler/components/cards/active-users.html.twig')]
