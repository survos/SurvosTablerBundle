<?php
/* src/Components/Cards/ForgotPasswordComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:forgot-password', template: '@SurvosTabler/components/cards/forgot-password.html.twig')]
