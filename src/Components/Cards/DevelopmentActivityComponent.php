...
#[AsTwigComponent(name: 'cards:development-activity', template: '@SurvosTabler/components/cards/development-activity.html.twig')]
final class DevelopmentActivityComponent
{
    use DataAwareTrait;
