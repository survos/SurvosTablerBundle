<?php
/* src/Components/Cards/SalesComponent.php v3.9 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'cards:sales', template: '@SurvosTabler/components/cards/sales.html.twig')]
final class SalesComponent
{
    use DataAwareTrait;
