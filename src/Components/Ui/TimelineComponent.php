<?php
/* src/Components/Ui/TimelineComponent.php v4.8 - Generated 2025-12-30 */
...
#[AsTwigComponent(name: 'ui:timeline', template: '@SurvosTabler/components/ui/timeline.html.twig')]
final class TimelineComponent
{
    use DataAwareTrait;
